ParallelMasterTracker <- function(compfolder, ncores=NULL, ParamsList){ 
  ...
  CalculateZeroVortRadiusDistance <- ParamsList$CalculateZeroVortRadiusDistance
  CalculateZeroVortRadiusNPoints <- round(CalculateZeroVortRadiusDistance/Resolution,0)
