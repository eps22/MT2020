TrackCenterCandidate <- function(compfolder,centertotrack,currentimeidx,resolution,timestep){
  ...
  slp <- ncvar_get(ncinslp,'slp',start = c(1,1,currentimeidx),count=c(-1,-1,3))/100
